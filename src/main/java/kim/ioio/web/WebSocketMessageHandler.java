...
import kim.ioio.web.Injector.WebSocketMessageMappingInjector;
...
public class WebSocketMessageHandler extends TextWebSocketHandler {
    ...
    @Autowired
    private WebSocketMessageMappingInjector webSocketMessageMappingInjector;
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) {
        ...
        webSocketMessageMappingInjector.process(session,message);
    }

    public static void sendMessageToUser(String targetUserId, String textMessage) {
    ...
    public static TextMessage convertWebSocketTextMessage(String textMessage) {
        return new TextMessage(textMessage);
    }

    public static void sendMessageToAllUsers(String textMessage) {
        Iterator iter = sessionUsers.entrySet().iterator();
        while (iter.hasNext()) {
            Map.Entry<String, WebSocketSession> entry = (Map.Entry) iter.next();
            WebSocketSession session = entry.getValue();
